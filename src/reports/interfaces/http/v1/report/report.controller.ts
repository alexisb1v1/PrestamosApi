...
import { LoanReportResultDto } from '../../../../application/queries/v1/dto/loan-report-result.dto';
...
export class ReportController {
  ...
  async getReport(
    ...
    const result = await this.queryBus.execute<GetLoanReportQuery, Result<LoanReportResultDto, AppError>>(
